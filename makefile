...
OBJS = src/main.o src/assembler.o src/preprocessor.o src/utils.o src/error.o src/validations.o src/file_manager.o src/output.o src/operations.o
...
src/output.o: src/file_manager.c include/output.h
